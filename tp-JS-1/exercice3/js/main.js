  ...
  let btn_stop=document.getElementById("stop");*/
   ...
   //La fonction "start" démarre un appel répétitive de la fonction update_chrono par une cadence de 100 milliseconde en utilisant setInterval 
   //et désactive le bouton "start"
  function start(){
